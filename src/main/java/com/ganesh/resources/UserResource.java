...
public class UserResource {
    ...
    @RequestMapping(path = "/{id}/{name}", method = RequestMethod.PUT, produces = "Application/json", consumes = "Application/json")
    User updateUser(@PathVariable("id") int id, @PathVariable("name") String name) {
